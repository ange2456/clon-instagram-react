import ProfilePic from "../../assets/img/usuario/iconoperfil.png";
//header es la parte del perfil donde se encuentran el numero de publicaciones ,hisorias descripcion y foto de perfil del usuario
const Header = () => {
  return (
    <>
        <header className="header">
            ...
            <div className="header-content">
                ...
                <div className="content-mid">
                    ...
                    <span> <strong>1 M</strong> seguidores</span>
                    <span> <strong>250</strong> seguidos</span>
                </div>
                <div className="content-button">
                    <span>Ange & Mayra</span>
                    <p>🔥 | TIENDA VIRTUAL ®SPORT</p>
                    <p>🇨🇴 | SOLO COLOMBIA</p>
                    <p>👟 | AL X MAYOR Y DETAL</p>
                </div>
            </div>
        </header>    
    </>
